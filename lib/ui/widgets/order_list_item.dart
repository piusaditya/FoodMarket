  ...
  Widget build(BuildContext context) {
    return Row(
      children: [
        Container(
            ...
            decoration: BoxDecoration(
                ...
                image: DecorationImage(
                    ...
                    fit: BoxFit.cover))),
        SizedBox(
          width: itemWidth - 182, // (60 width - 12 jarak - 110 rating stars,
          child: Column(
            crossAxisAlignment:
                CrossAxisAlignment.start, // alignment nama makanan dan harga
            children: [
              ...
              Text(
                '${transaction.quantity} item(s) , ' +
                    NumberFormat.currency(
                        ...
                        .format(transaction.total), // Harga item format idr
        ...
        SizedBox(
          width: 110, //pakai panjang rating star
          child: Column(
